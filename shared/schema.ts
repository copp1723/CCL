...
export const visitors = pgTable("visitors", {
  ...
  return {
    ...
    piiCompleteIdx: index("visitors_pii_complete_idx").on(table.piiComplete, table.abandonmentStep),
  };
});
...
export const systemLeads = pgTable("system_leads", {
  ...
  return {
    ...
    submissionAttemptsIdx: index("system_leads_submission_attempts_idx").on(table.submissionAttempts),
  };
});
